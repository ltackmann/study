...
% Triangle inequality theorem (third side is shorter than the sum of the two others and longer than their difference)
% - ex: can a triangle with side length 3.9, 3 and 6 (ans yes)
% - ex: 4.4 8.8 and 6 (ans yes)
% - ex: what is the range of the third side if the two others are 5.1 and 8 (ans 2.9 - 13.1)

% Topology is Africa smaller than greenland or Russia (answer no)

% congruent (translate, rotate, reflect)
