...
% - Markov chain (see Alexanders BA document) http://stats.stackexchange.com/questions/165/how-would-you-explain-markov-chain-monte-carlo-mcmc-to-a-layperson
...
% - Average absolute deviation http://en.wikipedia.org/wiki/Absolute_deviation#Average_absolute_deviation_.28general_form.29
% - mean and median absolute diviation http://en.wikipedia.org/wiki/Median_absolute_deviation
% - (Why Square?) http://www.mathsisfun.com/data/standard-deviation.html#WhySquare
...
% inter quartile range http://en.wikipedia.org/wiki/Interquartile_range
% http://itfeature.com/tag/quartile-deviation
% http://math.arizona.edu/~ghystad/chapter2.pdf
%
% - Time series http://en.wikipedia.org/wiki/Time_series (relation to Fast Fourier transform)

% Geometric mean http://www.investopedia.com/ask/answers/042815/what-geometric-mean-statistics.asp

% P values
% Bayes factors

% http://thismatter.com/money/insurance/risk.htm
...
Bernoulli’s theoretical result shows that by taking a sufficiently large sample, probabilities can be computed from a sample so that to any degree of certainty (other than absolute certainty), the computed probability is within any desired degree of accuracy of the true probability.

% TODO subjective and objective probability.38
...
% - check with The deviations on one side of the mean should equal the deviations on the other side.
\begin{description}
...
% TODO describe http://stats.stackexchange.com/a/17893
...
% TODO draw examples of the different dsitributions (symetrical/asymetrical, skewed (skewed to the right = right tailed, skewed to the left = left tailex ), http://stattrek.com/statistics/charts/data-patterns.aspx clusters, gaps, peeks, outliers
...
% TODO history and explanation http://www.r-tutor.com/elementary-statistics/probability-distributions/normal-distribution
