...
When multiplying numbers of different precision care should be taken when deciding on the precision of the result. To facilitate this the concept of \index{significant figures}{significant figures} has been invented. The significant figures of a number are those digits that carry meaning contributing to its precision. The procedure for identifying significant figures is as follows 
\begin{enumerate}
