...
public class HeaderComponent extends Composite implements HeaderPresenter.Display {
    ...
    interface HeaderComponenBinder extends UiBinder<HTMLPanel, HeaderComponent> {}
    private static HeaderComponenBinder uiBinder = GWT.create(HeaderComponenBinder.class);
